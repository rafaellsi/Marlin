...
#if (THERMISTORHEATER_0 == 987) || (THERMISTORHEATER_1 == 987) || (THERMISTORHEATER_2 == 987) || (THERMISTORHEATER_3 == 987) || (THERMISTORBED == 987) //10k bed thermistor
const short temptable_987[][2] PROGMEM = {
//10k Rapid 61-0446 ; Semitec 103GT-2
...
// Calculated using 4.7kohm pullup, voltage divider math, and manufacturer provided temp/resistance
   ...
   {950*OVERSAMPLENR, -10},
   {982*OVERSAMPLENR, -20},
   {1001*OVERSAMPLENR, -30},
   {1012*OVERSAMPLENR, -40},
   {1018*OVERSAMPLENR, -50},
};
...
const short temptable_10[][2] PROGMEM = {
   ...
   {88*OVERSAMPLENR, 230},
   {95*OVERSAMPLENR, 225},
   {102*OVERSAMPLENR, 220},
   {110*OVERSAMPLENR, 215},
   {119*OVERSAMPLENR, 210},
   {128*OVERSAMPLENR, 205},
   {138*OVERSAMPLENR, 200},
   {149*OVERSAMPLENR, 195},
   {161*OVERSAMPLENR, 190},
   {189*OVERSAMPLENR, 180},
   {221*OVERSAMPLENR, 170},
   {259*OVERSAMPLENR, 160},
   {303*OVERSAMPLENR, 150},
   {353*OVERSAMPLENR, 140},
   {410*OVERSAMPLENR, 130},
   {473*OVERSAMPLENR, 120},
   {540*OVERSAMPLENR, 110},
   {610*OVERSAMPLENR, 100},
   {679*OVERSAMPLENR, 90},
   {746*OVERSAMPLENR, 80},
   {807*OVERSAMPLENR, 70},
   {860*OVERSAMPLENR, 60},
